...
export const items: Array<Experience> = [
	{
		...
		location: 'Paris',
		period: { from: new Date(2021, 11, 30) },
	...
	},
	{
		...
		period: { from: new Date(2020, 9, 30), to: new Date(2021, 11, 30) },
	...
	},
	{
		...
		contract: ContractType.FullTime,
		location: 'Luxembourg',
		period: { from: new Date(2019, 2, 30), to: new Date(2019, 8, 30) },
	...
	},
	{
		...
		contract: ContractType.FullTime,
		location: 'Paris',
		period: { from: new Date(2018, 8, 30), to: new Date(2019, 2, 30) },
		type: 'Cybersecurity',		
		skills: getSkills(),		
		color: 'purple',
	...
	},
	{
		...
		period: { from: new Date(2017, 6, 30), to: new Date(2017, 8, 30) },
		type: 'Software Development',		
		skills: getSkills(),		
		color: 'blue',
